...
public class TestFinance {
	...
	public void TestPV() {
		...
		Retirement tester= new Retirement( iYearsToWork,  dAnnualReturnWorking,  iYearsRetired,  dAnnualReturnRetired,
			 dRequiredIncome,  dMonthlySSI);
		assertEquals(1454485.55,Math.abs(tester.TotalAmountToSave()),0.01);
		assertEquals(554.13,tester.MonthlySavings(),0.01);
		tester.setiYearsToWork(20);
		assertEquals(2792.11,tester.MonthlySavings(),0.01);
